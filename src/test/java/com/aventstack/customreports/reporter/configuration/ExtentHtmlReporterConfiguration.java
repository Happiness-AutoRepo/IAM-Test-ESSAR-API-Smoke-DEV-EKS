...
import com.aventstack.customreports.ResourceCDN;
...
public class ExtentHtmlReporterConfiguration extends BasicFileConfiguration implements IReporterConfiguration {
    ...
    /**
     * For {@link com.aventstack.customreports.reporter.ExtentHtmlReporter}, sets the location of charts 
     * 
    ...
    /**
     * For {@link com.aventstack.customreports.reporter.ExtentHtmlReporter}, sets the configuration to allow viewing or hiding charts on report open
     * 
