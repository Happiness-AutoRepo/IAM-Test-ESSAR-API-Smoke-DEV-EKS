...
import com.aventstack.customreports.feature.GherkinDialectProvider;
 ...
 * @see Status
 */
public class CustomReports extends Report {
     
    /**
     * Attach a {@link CustomReporter} reporter, allowing it to access all started tests, nodes and logs 
     * 
     * <p>
     ...
     * </ul>
     * 
     * @param reporter {@link CustomReporter} reporter
     */
    public void attachReporter(CustomReporter... reporter) {
     ...
     * 
     * @return A list of {@link CustomReporter}
     */
    public List<CustomReporter> getStartedReporters() {
     ...
     */
    public synchronized CustomTest createTest(Class<? extends IGherkinFormatterModel> type, String testName, String description) {
        CustomTest t = new CustomTest(this, type, testName, description);
     ...
     * @return {@link CustomTest} object
     */
    public synchronized CustomTest createTest(Class<? extends IGherkinFormatterModel> type, String testName) {
     ...
     * @return {@link CustomTest} object
     */
    public synchronized CustomTest createTest(GherkinKeyword gherkinKeyword, String testName, String description) {
     ...
     * @return {@link CustomTest} object
     */
    public synchronized CustomTest createTest(GherkinKeyword gherkinKeyword, String testName) {
     ...
     * @return {@link CustomTest} object
     */
    public synchronized CustomTest createTest(String testName, String description) {
        CustomTest t = new CustomTest(this, testName, description);
        applyCommonTestSettings(t);
     ...
     * @return {@link CustomTest} object
     */
    public synchronized CustomTest createTest(String testName) {
        return createTest(testName, null);
    }
    
    private synchronized void applyCommonTestSettings(CustomTest customTest) {
        customTest.setUseManualConfiguration(usesManualConfiguration);
    }
      
    /**
     * Removes a test
     * 
     * @param test {@link CustomTest} object
     */
    public synchronized void removeTest(CustomTest test) {
