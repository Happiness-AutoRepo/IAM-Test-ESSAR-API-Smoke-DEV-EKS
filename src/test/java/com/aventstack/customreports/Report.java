...
import com.aventstack.customreports.reporter.BasicFileReporter;
...
abstract class Report implements IReport {
    ...
    private List<CustomReporter> reporterCollection;
    ...
    protected void attach(CustomReporter reporter) {
    ...
    protected List<CustomReporter> getReporterCollection() {
    	return reporterCollection;
    }
    
    protected void detach(CustomReporter reporter) {
        reporter.stop();
    ...
    private synchronized void notifyReporters() {
        ...
        reporterCollection.forEach(CustomReporter::flush);
    }
    
    protected void end() {
        flush();
        
        reporterCollection.forEach(CustomReporter::stop);
