...
<head>
	...
	<script type='text/css'>@font-face {
...
.subview-left {
    ...
    /* -- [ collections ] -- */
    #test-collection li, #category-collection li, #author-collection li, #exception-collection li {
        border-bottom: 1px solid #eee;
        margin: 0 -20px;
        padding: 10px 20px;
    }
    #test-collection li:first-child, #category-collection li:first-child, #author-collection li:first-child,  #exception-collection li:first-child {
        border-top: 1px solid #eee;
    }
    #test-collection li.active, #category-collection li.active, #author-collection li.active,  #exception-collection li.active {
        background: #f7f7f7;
        font-weight: 600;
    }
    ...
    .subview-left .test-name, .subview-left  .category-name, .author-name, .exception-name, .node-name {
        display: inline-block;
        word-break: break-all;
    }
    ...
    .start-time, .category-status > .pass, .end-time, .category-status > .fail, .category-status > .others, .author-status > .pass, .author-status > .fail, .author-status > .others {
        color: #fff;
    }
    .start-time, .category-status > .pass, .author-status > .pass {
        background: #00c853;
    }
    .end-time, .category-status > .fail, .author-status > .fail {
        background: #ef5350;
    }
    .category-status > .others, .author-status > .others {
            background: #fbc02d;
    }
    .test-attributes {
        padding-top: 10px;
    }
    .test-steps, .category-tests, .author-tests, .exception-tests, .test-content > .node-list {
        margin-top: 30px;
    }
	...
	.category-name, .author-name, .exception-name {
		max-width: 80%;
		word-break: break-all;
	}
        /* -- [ screenshots ] -- */
    ...
    /* -- [ category-view and author-view ] -- */
    .category-tests th:first-child, .category-tests td:first-child, .exception-tests th:first-child, .exception-tests td:first-child, .author-tests th:first-child, .author-tests td:first-child {
        width: 180px;
    }
    .category-tests th:nth-child(2), .category-tests td:nth-child(2), .author-tests th:nth-child(2), .author-tests td:nth-child(2) {
        min-width: 50%;
    }
    .category.active .category-status, .author.active .author-status {
        display: none;
    }
    .linked {
        color: #039be5;
...
ul#exception-collection > li.exception, ul#category-collection > li.category, ul#author-collection > li.author {
    cursor: pointer;
}
...
.dark .grey.lighten-4, .dark .side-nav, .dark #test-collection li.active, .dark #category-collection li.active, .dark #author-collection li.active, .dark #exception-collection li.active, .dark .card-panel:not(.transparent), .dark .dropdown-content, .dark pre {
...
.dark .side-nav.fixed a, .dark pre, .dark .category, .dark .dropdown-content a, .dark #search-tests {
    color: #bbb !important;
}
...
.dark #test-collection li, .dark #category-collection li, .dark #author-collection li, .dark #exception-collection li, .dark th, .dark td, .dark .collapsible-body {
    border-bottom: 1px solid #333 !important;
}
.dark #test-collection li:first-child, .dark #category-collection li:first-child, .dark #author-collection li:first-child, .dark #exception-collection li:first-child {
